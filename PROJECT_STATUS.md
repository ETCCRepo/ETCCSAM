...
- **Git:** `main` branch, last commit `6c23ea2` ("Checkpoint v6.10: server-side Developer password verification, reset flow, Settings reorg"), pushed to `origin`. Working tree is clean.
